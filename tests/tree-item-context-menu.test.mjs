...
test('tree item context menu exposes new tab and new window actions', async () => {
  ...
  assert.deepEqual(
    ...
    ['Open in New Tab', 'Open in New Window', 'Copy Path', 'Copy Relative Path', 'Rename', 'Delete']
  )
  ...
  assert.deepEqual(sentMessages, [
    ...
    { channel: 'tree-item:rename', payload: 'docs/guide.md' },
    { channel: 'tree-item:delete', payload: 'docs/guide.md' }
  ])
